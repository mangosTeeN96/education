...
filepath_data_merge_byStdID = '../education_data/more/5.chengji_4_3in7/5.chengji_4_3in7.csv'

filepath_data_drop_subname6 = '../education_data/more/5.chengji_4_3in7/drop_subname6_data.csv'
...
def merge_score_stdInfo():
    ...
    # 将数据进行存储
    data_merge_byStdID.to_csv('../education_data/more/5.chengji_4_3in7/5.chengji_4_3in7.csv', encoding='utf_8_sig')
    print('完成文件加载！')
...
def drop_subname6_data():
    ...
    data_drop_sub5.to_csv('../education_data/more/5.chengji_4_3in7/drop_subname6_data.csv', encoding='utf_8_sig')
    print('存储完成！')
# drop_subname6_data()
