...
data_merge_byStdId = pd.read_csv('../education_data/more/5.chengji_3_claID/5.chengji_3_claID.csv')
...
def merge_data_byStdId():
    ...
    data.to_csv('../education_data/more/5.chengji_3_claID/5.chengji_3_claID.csv', encoding='utf_8_sig')
    print('存储完成！')
...
def split_data_byGrade():
    ...
    for i in range(3):
        ...
        filename = '../education_data/more/5.chengji_3_claID/' + grade_i[i] + '.csv'
...
def get_claName_byGrade():
    filepath = ['../education_data/more/5.chengji_3_claID/grade1.csv',
                '../education_data/more/5.chengji_3_claID/grade2.csv',
                '../education_data/more/5.chengji_3_claID/grade3.csv']
    cla_Name = []
    for i in range(3):
